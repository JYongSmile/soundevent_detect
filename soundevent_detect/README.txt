此项目是使用深度学习对洗衣机异音经行检测，从而实现自动对故障家电与正常家电经行分类的目的。项目内容如下：
...
noise_deep_train.py：       该程序是使用三层卷积核卷积神经网络对数据经行训练并给出预测结果
...
如果您的电脑安装的tensorflow是CPU或单GPU版训练，其他程序都用不上，请无视。
如果有什么疑问或者运行程序出现什么问题可以微信联系，欢迎交流沟通，共同进步！	微信号：TY9414201314  CADN博客：http://blog.csdn.net/barry_j
